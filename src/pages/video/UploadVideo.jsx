  ...
  return (
    <div className="min-h-screen bg-[#111827] flex pb-20 items-center justify-center p-4 sm:p-6">
      <motion.div
        ...
        className="max-w-lg w-full bg-linear-to-r from-[#0f2027] via-[#203a43] to-[#0f2027] p-8 rounded-3xl shadow-2xl border border-gray-700"
      >
        <button
          onClick={() => navigate(-1)}
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {loading && (
            <div className="w-full mt-4">
              ...
              <div className="w-full bg-gray-800 rounded-full h-4 overflow-hidden shadow-inner">
                <div
                  className="h-4 bg-linear-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-full transition-all duration-300 ease-in-out"
          ...
          <button
            type="submit"
            disabled={loading}
            className={`w-full py-3 rounded-lg font-medium bg-linear-to-r from-cyan-500 to-teal-400 text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-300 shadow-md ${
