...
export default function VideoPlayer() {
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen pb-20 bg-linear-to-br from-slate-800 to-gray-900 py-6 px-4 sm:px-6 lg:px-8"
    >
      {/* Top bar */}
      ...
      <motion.div
        ...
        className="w-full max-w-4xl bg-linear-to-r from-[#0f2027] via-[#203a43] to-[#0f2027] backdrop-blur-lg rounded-2xl shadow-2xl overflow-hidden"
      >
        {/* Video */}
