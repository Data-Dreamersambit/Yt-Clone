  ...
  return (
    <div className="min-h-screen bg-[#111827] flex items-center justify-center p-4 sm:p-6">
      <motion.div
        ...
        className="bg-linear-to-r from-[#0f2027] via-[#203a43] to-[#2c5364] p-8 sm:p-10 rounded-3xl shadow-2xl max-w-md w-full border border-gray-700"
      >
        {/* Heading */}
        ...
        <motion.button
          ...
          className="w-full py-3 rounded-lg bg-linear-to-r from-indigo-600 to-purple-600 text-white font-semibold shadow-lg hover:from-indigo-700 hover:to-purple-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
        >
