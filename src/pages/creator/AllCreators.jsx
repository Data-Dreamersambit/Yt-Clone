      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {creators.map((creator) => (
          <Link
            ...
            className="bg-linear-to-br from-gray-800 to-gray-900 hover:from-gray-700 hover:to-gray-800 transition-transform transform hover:scale-105 rounded-3xl shadow-lg hover:shadow-xl p-6 flex flex-col items-center text-center"
          >
