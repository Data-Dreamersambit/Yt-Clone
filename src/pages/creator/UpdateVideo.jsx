...
const UpdateVideo = () => {
  ...
  return (
    <div className="max-w-md w-full space-y-4 bg-linear-to-r from-[#0f2027] via-[#203a43] to-[#2c5364] p-6 sm:p-8 rounded-2xl shadow-xl border border-[#374151] mx-auto mt-10 text-white">
