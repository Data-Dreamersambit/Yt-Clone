          ...
          {playlists.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {playlists.map((playlist) => (
                <div
                  key={playlist._id}
                  className="bg-linear-to-b from-[#1b2838] to-[#111827] border border-gray-800 rounded-xl shadow-lg p-4 hover:border-blue-500 hover:shadow-blue-500/20 transition-all duration-300"
                >
