...
const UpdateUser = () => {
  ...
  return (
    ...
    >
      <div className="max-w-md w-full space-y-4 bg-linear-to-r from-[#0f2027] via-[#203a43] to-[#2c5364]  p-6 sm:p-8 rounded-2xl shadow-xl border border-[#374151]">
        ...
        <form className="mt-6 space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            <button
              ...
              className={`w-full flex justify-center py-2 px-4 rounded-md shadow-sm text-sm font-medium bg-linear-to-r from-cyan-500 to-teal-400 text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ${
