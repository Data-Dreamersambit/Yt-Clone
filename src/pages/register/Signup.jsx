...
const Signup = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-linear-to-l from-[#174336] via-[#203a43] to-[#174336] p-6">
      <motion.div
      ...
      >
        <h2 className="text-xl md:text-3xl font-extrabold text-center bg-linear-to-r from-emerald-400 to-teal-300 bg-clip-text text-transparent mb-6">
          Create Your Account
        </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <motion.button
            ...
            type="submit"
            disabled={loading}
            className="w-full py-3 rounded-lg bg-linear-to-r from-emerald-500 to-teal-400 text-gray-900 font-bold shadow-lg hover:from-emerald-600 hover:to-teal-500 transition-all disabled:opacity-50"
          >
            {loading ? (
