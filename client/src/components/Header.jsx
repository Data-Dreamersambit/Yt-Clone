...
function Header({ toggleSidebar }) {
  ...
  return (
    <>
      <header className="bg-linear-to-r from-[#0f1e29] via-[#142f44] to-[#0f1e29] p-2 text-gray-100 fixed top-0 z-50 w-full shadow-md">
        <div className="max-w-7xl px-2 sm:px-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <h1 className="text-2xl sm:text-4xl font-black uppercase bg-linear-to-r from-amber-300 via-yellow-400 to-orange-500 bg-clip-text text-transparent drop-shadow-[0_0_18px_#facc15] tracking-wider">
                Nexora
              </h1>
            </motion.div>
          </div>
          ...
          <div className="hidden sm:flex flex-1 mx-2 sm:mx-4 max-w-2xl">
            ...
            >
              ...
              <button
                type="submit"
                className="bg-linear-to-r from-amber-300 via-yellow-400 to-orange-500 text-gray-900 font-semibold px-4 py-2 transition-all duration-300 hover:scale-[1.05] hover:brightness-110"
              >
        ...
        {isMobileSearchOpen && (
          ...
          >
            ...
            >
              ...
              <button
                type="submit"
                className="shrink-0 bg-linear-to-r from-amber-300 via-yellow-400 to-orange-500 text-gray-900 font-semibold px-4 py-2 transition-all duration-300 hover:scale-[1.05] hover:brightness-110"
              >
                <FaSearch className="w-5 h-5" />
              </button>
            </form>
