...
const VideoCard = ({ video }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-linear-to-r from-[#0f2027] via-[#203a43] to-[#0f2027] rounded-xl overflow-hidden shadow-lg border border-gray-800 hover:border-indigo-500 cursor-pointer group"
    >
      {/* Thumbnail */}
