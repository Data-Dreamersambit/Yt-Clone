    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
      {currentUser.savedVideos.map((video) => (
        <motion.div
          ...
          className="rounded-xl overflow-hidden bg-linear-to-r from-[#0f2027] via-[#203a43] to-[#0f2027] border border-gray-800 shadow-md hover:shadow-2xl hover:border-blue-500 transition-all duration-300 cursor-pointer"
        >
          {/* Thumbnail */}
