...
const CreatePlaylist = () => {
  ...
  return (
    <div className="max-w-md mx-auto mt-8 p-6 bg-linear-to-r from-[#0f2027] via-[#203a43] to-[#0f2027] text-gray-100 rounded-xl shadow-xl border border-gray-700">
      {/* Back Button */}
      <button
        onClick={() => navigate(-1)}
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <button
          type="submit"
          className={`w-full bg-linear-to-r from-cyan-500 to-teal-400 text-gray-900 py-2 rounded-lg 
